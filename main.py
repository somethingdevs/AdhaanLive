...
import logging
from core.stream_refresher import smart_refresh_loop
from utils.livestream import get_m3u8_url
...
if __name__ == "__main__":
    ...
    smart_refresh_loop(lambda: get_m3u8_url("https://iaccplano.click2stream.com"))
